...
export const addPetCollection = (id, values, history) => async (dispatch) => {
    let result = await axios.put(`/pet/${id}`, {
        idCollections: values.collectionName,
    });
...
export const updatePetCollection = (values, id, history) => async (
    dispatch
) => {
