...
export { default as AddProduct } from '../pages/Product/AddProduct';
export { default as EditProduct } from '../pages/Product/EditProduct';
export { default as EditItemProduct } from '../pages/Product/EditItemProduct';
...
export { default as Transaction } from '../pages/PaymentVerification/Transaction';
export { default as ProductPurchased } from '../pages/PaymentVerification/Transaction';
