...
import { getMediumDog } from "../../redux/actions";
...
export default function MediumDog() {
        ...
        <Fragment >
            <Box component={Paper} className={classes.root}>
                <Container >
                    ...
                    >
                        <Grid>
                            <Typography className={classes.tablehead} variant="h4">Medium Dogs Collections</Typography>
                        </Grid>
                        {/* <Grid>
